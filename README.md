...
* [Communication With Cloud Services](#Communication-With-Cloud-Services)
	* [Connecting from web interface](#Connecting-from-web-interface)
		+ [Connection scheme VM->Camera](#Connection-scheme-VM->-Camera)
		+ [Exchanged queries VM->Camera](#Exchanged-queries-VM->-Camera)
	* [Connecting to Besder camera from ICSee app on a smartphone](#Connecting-to-Besder-camera-from-ICSee-app-on-a-smartphone)
		+ [Connection scheme Smartphone->AWS->Camera](#Connection-scheme-Smartphone->-AWS->-Camera)
		+ [Exchanged queries Smartphone->AWS->Camera](#Exchanged-queries-Smartphone->-AWS->-Camera)
